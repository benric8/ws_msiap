...
public class Constantes {
	...
	public static final String	MSJ_MOD_USER = "Modificando informaciÃ³n del usuario ";
	public static final String	SIN_VALOR_NULL	= "-SIN VALOR O NULL-";

	//PAR�METROS DE CONFIGURACI�N DEL SERVICIO WEB RENIEC
	...
	//PARÁMETROS DE CONFIGURACIÓN DEL SERVICIO WEB MINEDU
	...
	//PARÁMETROS DE CONFIGURACIÓN DEL SERVICIO WEB SUNEDU
	public static final String CONFIG_WS_SUNEDU_ENDPOINT = Mensaje.getString("msiap.wssunedu.endpoint");
	
	//RUTA DE VALIDACI�N DEL CERTIFICADO DE ANTECEDENTES PENALES
	...
	public static final String URI_METODO_CONSULTAR_WS_RENIEC_REST	="consultar/persona";
	...
	public static final String KEY_PERSONA_CONSULTADA_RENIEC = "personaConsultada";	
