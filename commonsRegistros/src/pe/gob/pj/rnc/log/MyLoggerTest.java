 ...
 * 
 * <p>
 * The example should make it clear that subclasses follow the hierarchy. You
 * should also try running this example with a <a href="doc-files/mycat.bad">bad</a>
 * and <a href="doc-files/mycat.good">good</a> configuration file samples.
 * 
 * <p>
...
public class MyLoggerTest {
	...
	static void usage(String errMsg) {
		...
		System.err.println("\nUsage: " + MyLogger.class.getName() + "[configFile]\n" + " where *configFile* is an optional configuration file, " + "either in properties or XML format.");
		System.exit(1);
	}
}
