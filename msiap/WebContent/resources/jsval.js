...
this.err_form="Ingrese o seleccione valores para los siguientes campos:\n\n";
this.err_select="El campo \"%FIELDNAME%\" no es válido, recuerde que los campos marcados con (*) son requeridos";
this.err_enter="El campo \"%FIELDNAME%\" no es válido, solo se permiten caracteres de la a-z, apostrofe y diéresis";
};
